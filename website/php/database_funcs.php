...
function add_product($code, $name, $description, $price, $categoryid,$admin_id)
{
	global $db;
	$query= "INSERT INTO Products (code, name, description, price, categoryid,administrator_id)
	         VALUES ('$code', '$name', '$description', $price, $categoryid, $admin_id)";
...
function get_products_by_category_by_admin($categoryid, $admin_id)
{
	global $db;
	$query="SELECT * 
	        FROM Products 
	        WHERE categoryid=$categoryid 
			AND administrator_id=$admin_id" ;
...
function get_products_by_admin($administrator_id)
{
	global $db;
	$query="SELECT * 
	        FROM Products 
